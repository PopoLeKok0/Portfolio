(function() {
  ...
  function setup() {
    ...
    // Store reference to animation ID in window for cleanup
    window.lightAnimationSetup = true;
  }
  ...
  function draw() {
    updatePipes();
    render();
    window.requestAnimationFrameId = window.requestAnimationFrame(draw);
  }
  ...
  function cleanup() {
    ...
    if (container && canvas && canvas.b) {
      container.removeChild(canvas.b);
    }
  }
  
  // Export functions to window
  window.lightSetup = setup;
  window.lightCleanup = cleanup;
})();